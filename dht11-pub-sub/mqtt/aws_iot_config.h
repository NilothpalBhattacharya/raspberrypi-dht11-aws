...
#define AWS_IOT_MQTT_HOST              "a3ofxmbr96dmyl-ats.iot.ap-south-1.amazonaws.com"
//< default port for MQTT/S
#define AWS_IOT_MQTT_PORT              8883
//< MQTT client ID should be unique for every device
#define AWS_IOT_MQTT_CLIENT_ID         "demo-client"
//< Thing Name of the Shadow this device is associated with
#define AWS_IOT_MY_THING_NAME 		   "DHT11"
//< Root CA file name
#define AWS_IOT_ROOT_CA_FILENAME       "5496b11b55-certificate.rootCA.pem"
//< device signed certificate file name
#define AWS_IOT_CERTIFICATE_FILENAME   "5496b11b55-certificate.pem.crt"
//< Device private key filename
#define AWS_IOT_PRIVATE_KEY_FILENAME   "5496b11b55-private.pem.key"
// =================================================

// MQTT PubSub
//< Any time a message is sent out through the MQTT layer. The message is copied into this buffer anytime a publish is done.
...
//< Maximum size of the SHADOW buffer to store the received Shadow message, including terminating NULL byte.
